...
*Last updated: 2026-09-15 after Phase 4 (2026-09-13.01 Setup v2 — read-only drift detection shipped: `preserved` outcome, typed facets, redaction by construction; Phases 1–3 closed #560, man pages, custom auth headers, and plugin-first delivery).*
