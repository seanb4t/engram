...
**v0.10.x — Hardening & Write Lane (Phase 17 complete 2026-07-13):**
...
- Connect write lane + auth hardening — proto contract + stub RPCs shipped Phase 15 (REQ-connect-write-rpcs), transport CSRF defense shipped Phase 16 (REQ-connect-csrf), wired write handlers with full MCP/Connect authz parity shipped Phase 17 (REQ-connect-write-authz-parity); remaining: session rotation (18) (#322/#323)
