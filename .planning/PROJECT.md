...
- Connect write lane + auth hardening — proto contract + stub RPCs shipped Phase 15 (REQ-connect-write-rpcs), transport CSRF defense shipped Phase 16 (REQ-connect-csrf); remaining: wired handlers (17), session rotation (18) (#322/#323)
