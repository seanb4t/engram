...
- [ ] **REQ-byte-budget-pages**: Pages end on an accumulated-byte budget as well as a record count, so a page of a few very large records stays under the receive limit.
