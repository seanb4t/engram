...
- [x] **REQ-p11-review-residuals**: The Phase-11 async-summary code-review residuals are resolved — WR-03 (`Wait` misuse), IN-01 (`storeMemory`/`scheduleMemory` duplicated Upsert-then-enqueue block), IN-02 (test hermeticity). *(GitHub #335)*
