...
- [x] **REQ-claude-md-migrations-convention**: CLAUDE.md's Conventions line "Not used here: database migrations" is revised to describe what this milestone actually ships, so the normative doc does not contradict the code.
...
| REQ-claude-md-migrations-convention | Phase 8 | Complete |
