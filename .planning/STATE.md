...
- **Nyquist coverage gap:** phase 26 still has `VALIDATION.md` at `status: draft`; `/gsd-validate-phase 26` reconciles it. Phase 24 was reconciled 2026-07-26 (0 gaps — every scaffolded test had already shipped).
